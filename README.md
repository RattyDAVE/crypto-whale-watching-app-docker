A docker version of https://github.com/pmaji/crypto-whale-watching-app

```
docker run -dit -p 8050:8050 rattydave/crypto-whale-watching
```


The Following is taken from https://github.com/pmaji/crypto-whale-watching-app
